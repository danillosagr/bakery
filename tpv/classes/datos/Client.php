...
class Client {
    ...
    private $id, $name, $surname, $tin, $address, $location, $postalcode, $province, $email, $telephone;
    
    function __construct($id = null, $name = null, $surname = null, $tin = null, $address = null,
    $location = null, $postalcode = null, $province = null, $email = null, $telephone = null) {
        $this->id = $id;
        $this->name = $name;
        $this->surname = $surname;  
        $this->tin = $tin;              //número de identificación
