            ...
            <div class="section-content">
                <div class="container">
                    <header class="section-header">
                        <h1>Busca por familia</h1>
                        <p>Ofrecemos productos gourmet, bollería, diferentes tipos de pan, tartas y pasteles</p>
                    </header>
                    
                    <div class="text-center onscroll-animate">
                    	<div class="filter-icons-container">
                           	<div class="filter-icon-wrapper">
                        		<a href="https://bakerywp-ruben1507.c9users.io/familia/gourmet/">
                       		...
                       		<div class="filter-icon-wrapper">
                            	<a href="https://bakerywp-ruben1507.c9users.io/familia/bolleria/">
                                	<div class="filter-icon-content">
                                        <div class="filter-icon">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                width="1000px" height="1000px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
                            ...
                            <div class="filter-icon-wrapper">
                            	<a href="https://bakerywp-ruben1507.c9users.io/familia/panaderia/">
                                	<div class="filter-icon-content">
                                        <div class="filter-icon">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                 width="1000px" height="1000px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
                            ...
                            <div class="filter-icon-wrapper">
                            	<a href="https://bakerywp-ruben1507.c9users.io/familia/pasteleria/">
                                	<div class="filter-icon-content">
                                        <div class="filter-icon">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                 width="1000px" height="1000px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
                    ...
                    <form role="search" method="get" id="searchform" class="form-search onscroll-animate fadeIn" action="">
                        <input type="text" placeholder="Búsqueda" value="" name="search" id="search">
                    </form>
                    ...
                    <!--<div class="text-center">
                        <div class="pagination">
                            <a href="#"><div class="pagination-item pagination-nav">prev</div></a>
                            <a href="#"><div class="pagination-item active">1</div></a>
                            <a href="#"><div class="pagination-item">2</div></a>
                            <a href="#"><div class="pagination-item">3</div></a>
                            <a href="#"><div class="pagination-item">4</div></a>
                            <a href="#"><div class="pagination-item">5</div></a>
                            <a href="#"><div class="pagination-item">6</div></a>
                            <a href="#"><div class="pagination-item">7</div></a>
                            <a href="#"><div class="pagination-item pagination-nav">next</div></a>
                        </div>
                    </div>-->
                </div><!-- .container -->
            </div><!-- .section-content -->
