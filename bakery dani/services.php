...
<div id="all">
        	...
        	<div class="offset-borders">
                <div class="full-header-container" id="header-services">
                    <div class="full-header">
                        <div class="container">
                            <h1>Servicios</h1>
                            <h3>Algunos de nuestros servicios principales</h3>
                        </div>
                    </div>
                </div>
            </div>
            	...
            	<article>
                    <div class="row">
                        <div class="col-md-6 onscroll-animate">
                            <img class="img-responsive" alt="services image" src="<?php echo get_template_directory_uri(); ?>/images/services_img.jpg">
                        ...
                        <div class="col-md-6 onscroll-animate" data-delay="500">
                            ...
                            <p>Desde los comienzos nos hemos preocupado por ir innovando en nuestros productos sin perder el carácter artesanal de los mismos, y prestando mucha atención a las exigencias de nuestros clientes. Hemos ido creando nuevas líneas de producción además del pan artesanal, el cual resaltamos el pan precocido y el congelado, nuestro producto estrella son los croissant por los cuales hemos ganado varios premios. Contamos con obrador propio en el que cada día se producen pasteles, tartas, bollería, todo con una gran calidad y variedad.</p>
                            <p>La empresa cuenta con unas instalaciones renovadas desde donde se distribuye el producto por toda el país, a nuestros clientes formados por restaurantes, cafeterías, croissanterías, hoteles, colegios, etc, sin olvidar nuestros propias tiendas distribuidas por España. </p>
                        </div>
                    </div>
                </article>
            </div>
            ...
            <div class="section-content">
                <div class="container">
                    <header class="section-header">
                        <h1>SERVICIOS QUE PROVEEMOS</h1>
                        <p>Nuestros servicios son considerados por muchos los mejores del país, ofrecemos la mejor calidad y atención del mercado.</p>
                    </header>
                    ...
                    <div class="row">
                    	<div class="col-md-4 onscroll-animate">
                        	<article class="article-short">
                                ...
                                <div class="article-short-content">
                                	<h1>Mejores Chefs</h1>
                                	<p>Tenemos a los mejores chefs reposteros y panaderos de España haciendo trabajando para nosotros.</p>
                        ...
                        <div class="col-md-4 onscroll-animate" data-delay="400">
                        	<article class="article-short">
                                ...
                                <div class="article-short-content">
                                	<h1>Bollería y dulces</h1>
                                	<p>Contamos con la mayor variedad y con las mejores calidades del sector. Nuestros cruasanes son los nº 1.</p>
                        ...
                        <div class="col-md-4 onscroll-animate" data-delay="600">
                        	<article class="article-short">
                                ...
                                <div class="article-short-content">
                                	<h1>PAN</h1>
                                	<p>Llévese su pan recién horneado a casa, horneamos 3 veces al día para obtener la mejor calidad.</p>
                    ...
                    <div class="row">
                    	<div class="col-md-4 onscroll-animate">
                        	<article class="article-short">
                                ...
                                <div class="article-short-content">
                                	<h1>TARTAS DE BODA</h1>
                                	<p>Deje que seamos nosotros quien se encargue de la tarta para ese día tan especial.</p>
                        ...
                        <div class="col-md-4 onscroll-animate" data-delay="400">
                        	<article class="article-short">
                                ...
                                <div class="article-short-content">
                                	<h1>CROISSANTS</h1>
                                	<p>Hacemos los croissants nº1 en España. ¡Tiernos, jugosos y muy sabrosos!</p>
                        ...
                        <div class="col-md-4 onscroll-animate" data-delay="600">
                        	<article class="article-short">
                                ...
                                <div class="article-short-content">
                                	<h1>TALLERES</h1>
                                	<p>Aprende de repostería con nuestros mejores chefs reposteros en nuestros talleres </p>
        ...
        <section id="services-slider-container">
        	<div id="services-slider" class="services-slider">
                <div class="services-slider-it">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/images/services1.jpg">
                    <div class="services-slider-detail-container">
                    	<div class="services-slider-detail">
                            <div class="services-slider-detail-content">
                                <h3>Croissants</h3>
                                <p>bakery, cakery</p>
                            </div>
                        </div>
                ...
                <div class="services-slider-it">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/images/services2.jpg">
                    <div class="services-slider-detail-container">
                    	<div class="services-slider-detail">
                            <div class="services-slider-detail-content">
                                <h3>Croissants</h3>
                ...
                <div class="services-slider-it">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/images/services3.jpg">
                    <div class="services-slider-detail-container">
                    	<div class="services-slider-detail">
                            <div class="services-slider-detail-content">
                                <h3>Croissants</h3>
                ...
                <div class="services-slider-it">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/images/services4.jpg">
                    <div class="services-slider-detail-container">
                    	<div class="services-slider-detail">
                            <div class="services-slider-detail-content">
                                <h3>Croissants</h3>
                ...
                <div class="services-slider-it">
                    <img alt="" src="<?php echo get_template_directory_uri(); ?>/images/services5.jpg">
                    <div class="services-slider-detail-container">
                    	<div class="services-slider-detail">
                            <div class="services-slider-detail-content">
                                <h3>Croissants</h3>
