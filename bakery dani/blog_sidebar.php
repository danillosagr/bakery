                ...
                <div class="ms-fullscreen-template">
                    <div class="master-slider ms-skin-round" id="masterslider">
                        <div class="ms-slide">
                            ...
                            <div class="ms-layer">
                            	<h2 class="ms-layer" data-type="text" data-effect="rotate3dbottom(30,0,0,70)">La mejor bollería artesanal</h2>
                                <h3 class="ms-layer" data-type="text" data-effect="rotate3dbottom(30,0,0,70)" data-delay="200">Sabor y placer en el mismo momento</h3>
                            </div>
                        </div><!-- .ms-slide -->
                        <div class="ms-slide">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/slider/2.jpg" alt="header img">     
                            <div class="ms-layer">
                            	<h2 class="ms-layer ms-right" data-type="text" data-effect="rotate3dright(30,0,0,70)">Pan recién hecho a cualquier hora</h2>
                                <h3 class="ms-layer ms-right" data-type="text" data-effect="rotate3dright(30,0,0,70)">Horneamos pan 3 veces al día</h3>
                            </div>
                        </div><!-- .ms-slide -->
                        <div class="ms-slide">
                            <img src="<?php echo get_template_directory_uri(); ?>/images/slider/3.jpg" alt="header img">     
                            <div class="ms-layer">
                            	<h2 class="ms-layer" data-type="text" data-effect="rotate3dtop(30,0,0,70)">Panadería Nº1 en España</h2>
                                <h3 class="ms-layer" data-type="text" data-effect="rotate3dtop(30,0,0,70)">Premio a la mejor panadería de España 2017</h3>
                            </div>
                        </div><!-- .ms-slide -->
                    </div><!-- .master-slider -->
            ...
            <div class="section-content">
                <div class="container">
                                ...
                                <div class="col-md-6 onscroll-animate">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="product">
                                                ...
                                                <div class="product-preview">
                                                    <a href="gallery_single.html"><img alt="product 1" src="<?php echo get_template_directory_uri(); ?>/images/product1.png"></a>
                                                </div>
                                                <div class="product-detail-container">
                                                    ...
                                                    <div class="product-detail">
                                                        <h2><a href="gallery_single.html">Croissant</a></h2>
                                                        <p>Bakery, Cakery</p>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="product">
                                                <div class="product-preview">
                                                    <a href="gallery_single.html"><img alt="product 2" src="<?php echo get_template_directory_uri(); ?>/images/product2.png"></a>
                                                </div>
                                                <div class="product-detail-container">
                                                    <div class="product-icons">
                                                        <div class="product-icon-container">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="product">
                                                ...
                                                <div class="product-preview">
                                                    <a href="gallery_single.html"><img alt="product 3" src="<?php echo get_template_directory_uri(); ?>/images/product3.png"></a>
                                                </div>
                                                <div class="product-detail-container">
                                                    <div class="product-icons">
                                                        <div class="product-icon-container">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="product">
                                                <div class="product-preview">
                                                    <a href="gallery_single.html"><img alt="product 4" src="<?php echo get_template_directory_uri(); ?>/images/product4.png"></a>
                                                </div>
                                                <div class="product-detail-container">
                                                    <div class="product-icons">
                                                        <div class="product-icon-container">
                                ...
                                <div class="col-md-6 onscroll-animate">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="product">
                                                <div class="product-preview">
                                                    <a href="gallery_single.html"><img alt="product 5" src="<?php echo get_template_directory_uri(); ?>/images/product5.png"></a>
                                                </div>
                                                <div class="product-detail-container">
                                                    <div class="product-icons">
                                                        <div class="product-icon-container">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="product">
                                                ...
                                                <div class="product-preview">
                                                    <a href="gallery_single.html"><img alt="product 6" src="<?php echo get_template_directory_uri(); ?>/images/product6.png"></a>
                                                </div>
                                                <div class="product-detail-container">
                                                    <div class="product-icons">
                                                        <div class="product-icon-container">
                                ...
                                <div class="col-md-6 onscroll-animate" data-delay="300">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="product">
                                                <div class="product-preview">
                                                    <a href="gallery_single.html"><img alt="product 7" src="<?php echo get_template_directory_uri(); ?>/images/product7.png"></a>
                                                </div>
                                                <div class="product-detail-container">
                                                    <div class="product-icons">
                                                        <div class="product-icon-container">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="product">
                                                <div class="product-preview">
                                                    <a href="gallery_single.html"><img alt="product 8" src="<?php echo get_template_directory_uri(); ?>/images/product8.png"></a>
                                                </div>
                                                <div class="product-detail-container">
                                                    <div class="product-icons">
                                                        <div class="product-icon-container">
                    ...
                    <p class="text-center onscroll-animate">
                        <a href="#" class="button-void">See all our products</a>
                    </p>
                ...
                <div id="testimonials-slider" class="testimonials-slider">
                    <div class="container">
                        <div class="testimonial centered-columns">
                            ...
                            <div class="testimonial-name">Charles M. Schulz</div>
                    ...
                    <div class="container">
                        <div class="testimonial centered-columns">
                            ...
                            <div class="testimonial-name">Brandon Razer</div>
                            <div class="centered-column">
                                <div class="testimonial-content">
                                    “All you need is love. But a little chocolate now and then doesn't hurt.”
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="service-box">
                                        ...
                                        <a class="read-more-link" href="services.html">Read more</a>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="service-box">
        ...
        <section id="heading-section" class="section-white-cover parallax-background">
            <div class="section-content">
                <div class="container">
                    ...
                    <h2 class="heading-huge">Different types of bread products</h2>
            ...
            <div class="section-content">
                <div class="container">
                    <header class="section-header onscroll-animate">
                        ...
                        <p>
                            See our big range of departaments, whe offer a lot of attention to our patients<br>
                                    ...
                                    <div class="centered-columns offer-box">
                                        <div class="offer-box-left centered-column">
                                            <div class="offer-info">
                                                ...
                                                <div class="margin-100"></div>
                                                <h2 class="text-huge">$6.88 <a href="#" class="button">Order Now <i class="fa fa-long-arrow-right"></i></a></h2>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="recent">
                                <article>
                                    <div class="centered-columns offer-box">
                                        ...
                                        <div class="offer-box-right centered-column" style="background-image:url('images/offer1.png');">
                                            <div class="product-label-container big-label">
                                                <div class="product-label">
                                                    Week’s best seller
                                                </div>
        ...
        <section id="posts-section">
            <div class="section-content">
                <div class="container">
                    <header class="section-header onscroll-animate">
                        <h1>Blog posts</h1>
                        <p>Check our latest Blog Posts, what we are talking about</p>
                    </header>
                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="post">
                                    <div class="post-image">
                                        <div id="post-images-slider-1" class="post-images-slider">
                                            <a href="blog_single.html"><img alt="post image 1" src="<?php echo get_template_directory_uri(); ?>/images/post_image1.png"></a>
                                        </div>
                                    </div>
                                    <div class="post-data">
                                        <h2><a href="blog_single.html">Coffe combines perfectly with Croissants</a></h2>
                                        <p>Now when I looked about the quarter-deck, for some one having authority, in order to propose myself as a candidate for the voyage.</p>
                                    </div>
                                    <div class="post-info">
                                        by <a href="blog_single.html">admin</a> <span class="simple-delimiter"></span> on <a href="blog_single.html">24.04.2014</a> <span class="simple-delimiter"></span> <a href="blog_single.html">23 Comments</a>
                                    </div>
                                </div><!-- .post -->
                                <div class="margin-60"></div>
                            </div><!-- .col-md-4 -->
                            <div class="col-md-4 onscroll-animate" data-delay="300">
                                <div class="post">
                                    <a href="blog_single.html">
                                        <div class="post-image">
                                            <img alt="post image 2" src="<?php echo get_template_directory_uri(); ?>/images/post_image2.png"> 
                                        </div>
                                    </a>
                                    <div class="post-data">
                                        <h2><a href="blog_single.html">Friday Fresh Recipes</a></h2>
                                        <p>Now when I looked about the quarter-deck, for some one having authority, in order to propose myself as a candidate for the voyage.</p>
                                    </div>
                                    <div class="post-info">
                                        by <a href="blog_single.html">admin</a> <span class="simple-delimiter"></span> on <a href="blog_single.html">24.04.2014</a> <span class="simple-delimiter"></span> <a href="blog_single.html">23 Comments</a>
                            ...
                            <div class="col-md-4 onscroll-animate" data-delay="400">
                                <div class="post">
                                    <a href="blog_single.html">
                                        <div class="post-image">
                                            <img alt="post image 3" src="<?php echo get_template_directory_uri(); ?>/images/post_image3.png"> 
                                        </div>
                                    </a>
                                    <div class="post-data">
                                        <h2><a href="blog_single.html">Baking for Large amount of People</a></h2>
                                        <p>Now when I looked about the quarter-deck, for some one having authority, in order to propose myself as a candidate for the voyage.</p>
                                    </div>
                                    <div class="post-info">
                                        by <a href="blog_single.html">admin</a> <span class="simple-delimiter"></span> on <a href="blog_single.html">24.04.2014</a> <span class="simple-delimiter"></span> <a href="blog_single.html">23 Comments</a>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="post">
                                    <a href="blog_single.html">
                                        <div class="post-image">
                                            <img alt="post image 1" src="<?php echo get_template_directory_uri(); ?>/images/post_image1.png"> 
                                        </div>
                                    </a>
                                    <div class="post-data">
                                        <h2><a href="blog_single.html">Coffe combines perfectly with Croissants</a></h2>
