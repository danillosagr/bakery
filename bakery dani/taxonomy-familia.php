            ...
            <div class="section-content">
                <div class="container">
                    <header class="section-header">
                        <h1><?php echo get_post_meta($post->ID, 'my_meta_box_select', true); ?></h1>
                        <p>Echa un vistazo a los mejores productos de esta familia</p>
                    </header>
                 	...
                 	<div class="row">
                        ...
                        $args=array( 
                            ...
                            'tax_query' => array(
                                array(
			                        'taxonomy' => 'familia',
			                        'terms'    => get_post_meta($post->ID, 'my_meta_box_select', true),
			                        'field' => 'slug',
			                    ),
	                        ),
                        );
